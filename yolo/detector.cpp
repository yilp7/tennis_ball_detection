...
{
    string classesFile = "/Users/txiong/workspace/weights/coco.names";
    ifstream ifs(classesFile.c_str());
    string line;
    while(getline(ifs,line))classes.push_back(line);

    cv::String modelConfiguration = "/Users/txiong/workspace/weights/yolov4-leaky-416.cfg";
    cv::String modelWeights = "/Users/txiong/workspace/weights/yolov4-leaky-416.weights";
...
void drawPred(int classId,float conf,int left,int top,int right,int bottom,cv::Mat& frame){
    ...
    cv::putText(frame, label,cv::Point(left, top-10), cv::FONT_HERSHEY_SIMPLEX, 0.8, cv::Scalar(255, 178, 50), 2);
}
